...
<head>
  ...
  <meta
    ...
    content="Write a simple smart contract in Rust that can be deployed to a Soroban runtime on the Stellar network."
  />
  <link
    rel="canonical"
...
In this section, we wrote a simple contract that can be deployed to the Stellar network.
