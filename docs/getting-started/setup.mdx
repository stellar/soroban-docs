...
The Soroban CLI can work with any Stellar network, like Mainnet (Pubnet), Testnet, or a local network.
...
- Allows for customizing resource limits: matching Testnet/Mainnet, or unlimited.
...
A local test network is a fully featured Stellar network that runs the same protocol, software, and services as Testnet, or Mainnet, but it's isolated to your own local machine.
